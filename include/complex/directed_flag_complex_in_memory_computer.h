...
public:
	...
	inline coboundary_iterator_t<directed_flag_complex_in_memory_computer_t> coboundary(index_t cell) {
		...
		return coboundary_iterator_t<directed_flag_complex_in_memory_computer_t>(
		    this, current_dimension, coboundary_matrix[i], cell - coboundary_matrix_offsets[i]);
	}
